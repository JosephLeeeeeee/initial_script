...
# For Ubuntu 22.04, don't upgrade sudo
sudo apt-mark hold sudo
sudo apt-get upgrade -yq
echo -e "\n\033[33mSystem update completed\033[0m\n"

# apt-get install Git, git-lfs, tmux, nload, iproute2, lsof, btop
sudo apt-get install -yq git git-lfs tmux nload iproute2 lsof btop
